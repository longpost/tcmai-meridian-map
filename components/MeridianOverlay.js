...
export default function MeridianOverlay({ activeMeridian = "ST", side = "front", opacity = 0.95 }) {
  ...
  const clipId = side === "back" ? "bodyClipBack" : "bodyClipFront";
  const outlineD = side === "back" ? BODY_OUTLINE_BACK_D : BODY_OUTLINE_FRONT_D;
